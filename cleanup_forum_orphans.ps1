# ============================================================================
# Script PowerShell pour nettoyer les orphelins restants du forum
# ============================================================================
# Ce script exécute cleanup_forum_orphans.sql pour supprimer les enregistrements
# restants après la première exécution qui a échoué partiellement
# ============================================================================
...
$sqlScript = Join-Path $PSScriptRoot "cleanup_forum_orphans.sql"
...
Write-Host "🧹 Nettoyage des orphelins restants du forum" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "  - Les permissions orphelines liées au forum" -ForegroundColor Yellow
Write-Host "  - Les logs d'administration liés au forum" -ForegroundColor Yellow
Write-Host "  - Les content types restants du forum" -ForegroundColor Yellow
Write-Host "  - Les migrations restantes du forum" -ForegroundColor Yellow
Write-Host ""
...
Write-Host ""
Write-Host "🔄 Exécution du script de nettoyage..." -ForegroundColor Cyan
...
try {
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        Write-Host "   Les orphelins du forum ont été supprimés de la base de données." -ForegroundColor Green
    } else {
        Write-Host ""
